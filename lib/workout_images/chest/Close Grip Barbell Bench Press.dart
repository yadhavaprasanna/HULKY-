...
class BarbellCloseGripBenchPressUpperArms extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=nEF0bv2FW94';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/BarbellCloseGripBenchPressUpperArms.gif",
              ),
            ),
            SizedBox(
