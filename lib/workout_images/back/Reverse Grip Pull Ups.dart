...
class ReverseGripPullUps extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=UfhT0OSUU0w';
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text("Lats, Upper Back, Rear Delts and Biceps",
                          style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/back/Chin-Up_Back.gif",
              ),
            ),
            SizedBox(
