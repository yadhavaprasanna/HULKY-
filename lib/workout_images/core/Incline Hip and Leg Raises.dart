...
class InclineHipandLegRaises extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=mz9nf23RtDE';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/core/04911301-Incline-Leg-Hip-Raise-leg-straight_waist_360.gif",
              ),
            ),
            SizedBox(
