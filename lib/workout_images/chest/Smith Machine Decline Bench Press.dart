...
class SmithDeclinedBenchPress extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=39qwRmE6ffc';
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Position an decline bench below the barbell of a Smith Machine.Lie on the bench with your chest under the bar and place your feet under the leg rest. Place your hands outside of shoulder width on the barbell. Create an arch in your lower back and push your chest up.Push the barbell up then immediately rotate it so the hooks turn out. Slowly lower the barbell to chest level with your elbows pointing inwards at a 45 degree angle. Push the barbell back up to the starting position.",
                    style: TextStyle(
                        color: Colors.white,
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/SmithDeclineBenchPressChest360.gif",
              ),
            ),
            SizedBox(
