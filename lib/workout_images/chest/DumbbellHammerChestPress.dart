...
class DumbbellHammerChestPress extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=VmB1G1K7v94';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/DumbbellLyingHammerPressChest.gif",
              ),
            ),
            SizedBox(
