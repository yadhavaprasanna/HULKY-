...
class VegGain extends StatelessWidget {
  @override
                  ...
                  children: [
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          child: Center(
                              child: Text(
                        '100 gms Boiled Chickpeas and\n 50 gms of roasted Groundnuts',
                        style: TextStyle(
                            fontFamily: 'Oswald',
                            fontSize: size.width * .06,
                            fontWeight: FontWeight.w300),
                    ...
                    TableRow(children: [
                      ...
                      Container(
                          child: Center(
                              child: Text(
                        'Brown Rice Pulao with Sprouts \n and Paneer + 150 gms Curd. ',
                        style: TextStyle(
                            fontFamily: 'Oswald',
                            fontSize: size.width * .06,
                            fontWeight: FontWeight.w300),
