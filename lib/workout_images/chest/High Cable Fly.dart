...
class HighCableFly extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=taI4XduLpTk';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/CableStandingUpStraightCrossoversChest.gif",
              ),
            ),
            SizedBox(
