...
class NarrowGripSeatedRow extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=GZbfZ033f74';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/back/Cable-Straight-Back-Seated-Row_Back.gif",
              ),
            ),
            SizedBox(
