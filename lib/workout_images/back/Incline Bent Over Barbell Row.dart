...
class InclineBentOverBarbellRow extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=vaPK9vXPB58';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/back/BarbellInclineRowBack.gif",
              ),
            ),
            SizedBox(
