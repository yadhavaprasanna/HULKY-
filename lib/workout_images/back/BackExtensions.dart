...
class BackExtensions extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=ph3pddpKzzw';
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(" Lower Back, Erector Spinae, Hamstrings, Glutes",
                          style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/back/BackExtensions.gif",
              ),
            ),
            SizedBox(
