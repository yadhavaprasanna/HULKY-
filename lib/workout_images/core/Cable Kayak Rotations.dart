...
class CableKayakRotations extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=pAplQXk3dkU';
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text("Obliques, Abs, Serratus Anterior, Lats, Pecs",
                          style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/core/24641301-Cable-Thibaudeau-Kayak-Row_Back_360-1.gif",
              ),
            ),
            SizedBox(
