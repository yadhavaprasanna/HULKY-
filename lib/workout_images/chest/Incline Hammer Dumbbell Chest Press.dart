...
class InclineHammerDumbbellpress extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=WCAIi9xvNR8';
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Lie on an incline bench holding a dumbbell in each hand with an inverted grip holding the dumbbells straight above your chest. Your palms should be facing each other. Place your feet on the ground in line with or behind your knees. Create an arch in your lower back and push your chest up. Slowly lower the dumbbells out and down to chest level in a half circle formation with a bend in your elbows. Lower the dumbbells to chest level. You should feel a stretch across your chest.As you push the dumbbells up, move your arms in an arc to bring the dumbbells together, until they meet over the centre of your chest.",
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: size.height * .020,
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/DumbbellInclineHammerPressChest.gif",
              ),
            ),
            SizedBox(
