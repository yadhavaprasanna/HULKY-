...
class Inclinelyingdumbbellcurls extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=OK6vpxXZ2pk';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/biceps/inclineddumbellcurl.gif",
              ),
            ),
            SizedBox(
