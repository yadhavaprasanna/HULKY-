...
class RearDeltPull extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=eIq5CB9JfKE';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/shoulder/02031301-Cable-Rear-Delt-Row-with-rope_Shoulders_360.gif",
              ),
            ),
            SizedBox(
