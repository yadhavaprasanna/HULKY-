...
class MachineRearDeltFly extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=6yMdhi2DVao';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/shoulder/Lever-Seated-Reverse-Fly-parallel-grip_shoulder_360.gif",
              ),
            ),
            SizedBox(
