...
class InclineMachineChestPress extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=ig0NyNlSce4';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/LeverInclineChestPressChest.gif",
              ),
            ),
            SizedBox(
