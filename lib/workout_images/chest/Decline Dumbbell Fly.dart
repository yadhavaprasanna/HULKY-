...
class DeclineDumbbellFly extends StatelessWidget {
  void _launchURLApp() async {
    const url = 'https://www.youtube.com/watch?v=IMALXhhHRKM';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Image.asset(
                "assets/workout_gif/chest/DumbbellDeclineFlyChest.gif",
              ),
            ),
            SizedBox(
